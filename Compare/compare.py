...
def getcount():
	...
	print "%-20s%-20s%-5s" %("my results","his results","gid")
	i=1
	for a,b in zip(List1,List2):
		print "%-20s%-20s%-5s" %(a,b,i)
		i+=1
getcount()
...
def compare_speed():
	...
	print "%-20s%-20s%-20s%-20s" %("gid","my results","his results","difference")
	for i,j in List3:
		for k,l in List4:
			if i==k:
				print "%-20s%-20s%-20s%-20s" %(i,j,l,j-l)
timeslice=1
#compare_speed()
