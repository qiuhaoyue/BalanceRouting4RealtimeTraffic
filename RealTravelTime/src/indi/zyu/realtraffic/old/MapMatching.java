...
import indi.zyu.realtraffic.road.MatchEntry;
				    		...
				    		for(int k=0; /*route_success &&*/ k<pre_match_candidates.size();k++){
				    			...
				    			*/
				    			...
				    			try{
				    				...
				    				path.clear();
					    			routing_instance.shortest_path(database, roadmap_table, intersection_table, (int)pre_candidate.road.gid, pre_candidate.offset, (int)cur_candidate.road.gid, cur_candidate.offset, path);
					    			String new_path="";
					    			double new_cost=0.0;
