...
public class MatchEntry {
	...
	public double transit_weight;
	double transit_distance;
	double circle_distance;
	
	public int pre_entry_index;
	public double final_weight=-1.0;
	
	public String path="";
	
	public MatchEntry(RoadSegment can_road, double percent, double lon, double lat, double local_distance){
		this.road=can_road;
		this.offset=percent;
		this.lat=lat;
		this.lon=lon;
